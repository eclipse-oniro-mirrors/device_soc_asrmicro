...
///HID Device Role
#if defined(SONATA_CFG_PRF_HOGPD)
#define BLE_HID_DEVICE          1
#else
#define BLE_HID_DEVICE          0
#endif // defined(SONATA_CFG_PRF_HOGPD)

///HID Boot Host Role
#if defined(SONATA_CFG_PRF_HOGPBH)
#define BLE_HID_BOOT_HOST       1
#else
#define BLE_HID_BOOT_HOST       0
#endif // defined(SONATA_CFG_PRF_HOGPBH)

///HID Report Host Role
#if defined(SONATA_CFG_PRF_HOGPRH)
#define BLE_HID_REPORT_HOST     1
#else
#define BLE_HID_REPORT_HOST     0
#endif // defined(SONATA_CFG_PRF_HOGPRH)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
        ...
        || BLE_CGM_SERVER || BLE_DBG_THPP || BLE_OTA_SERVER || BLE_BREEZE_SERVER)
