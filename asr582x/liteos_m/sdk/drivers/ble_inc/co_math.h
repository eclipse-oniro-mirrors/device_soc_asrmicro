...
extern void (*pf_srand)(unsigned int seed); // added by asr for rom 20200407
extern int (*pf_rand)(void); // added by asr for rom 20200407
...
{
    return (uint16_t)(pf_rand() & 0xFFFF);
}
