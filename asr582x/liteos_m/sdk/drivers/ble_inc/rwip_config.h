...
#define HZ32000                                     (1) // modified by asr for fpga verification 191217//(GAIA_SUPPORT)

/// Time to wake-up Radio Module (in us)
#define SLEEP_RM_WAKEUP_DELAY                       1354//2500//4500//1220//40//2000//625
/// Time for stabilization of the high frequency oscillator following a sleep-timer expiry (in us)
#define SLEEP_OSC_NORMAL_WAKEUP_DELAY               500//500//244//8//5000
/// Time for stabilization of the high frequency oscillator following an external wake-up request (in us)
#define SLEEP_OSC_EXT_WAKEUP_DELAY                  2354//3500//5500//6100//200//5000
...
#define IP_PROG_DELAY_DFT  (3) //(3)->(9) modified for flash version @asr
                               //(9)->(3) modified for bc_mas_p2p_tc_126/bc_sla_p2p_tc_78/bc_sla_p2p_tc_79
...
/* --------------------------      MISC SETUP       --------------------------------------*/
/******************************************************************************************/
/// Manufacturer: ASR SAS
#define RW_COMP_ID                           0x0060
#define ASR_SH_COMP_ID                       0x0910    // added by asr 20200709
#define ASR_SZ_COMP_ID                       0x0917    //added by asr 20200709
...
//#if (BLE_HOST_PRESENT)  // removed by asr for rom 20200227
#include "rwble_hl_config.h"  // ble Host stack configuration
//#endif //BLE_HOST_PRESENT  // removed by asr for rom 20200227

// removed by asr 20200606 start
#if 0
#if defined(CFG_APP)
#include "rwapp_config.h"     // Application configuration
#endif // defined(CFG_APP)
#endif
// removed by asr 20200606 end
...
enum KE_EVENT_TYPE
{
    //#if DISPLAY_SUPPORT  // removed for rom 20200226
    KE_EVENT_DISPLAY,
    //#endif //DISPLAY_SUPPORT   // removed for rom 20200226
    ...
    //#if (BLE_MESH)      // removed by asr for rom 20200227
    KE_EVENT_BLE_MESH_DJOB ,
    //#endif // (BLE_MESH)  // removed by asr for rom 20200227
    ...
    //#if (TRACER_PRESENT)  // removed by asr for rom 20200226
    KE_EVENT_TRC,
    //#endif /*(TRACER_PRESENT)*/  // removed by asr for rom 20200226

    //#if H4TL_SUPPORT  // removed by asr for rom 20200227
    KE_EVENT_H4TL_TX,
    #if (BLE_EMB_PRESENT || BT_EMB_PRESENT)
    ...
    //#endif //H4TL_SUPPORT  // removed by asr for rom 20200227
...
//#if (BLE_APP_PRESENT)     // removed for rom 20200226 
    TASK_APP,
//#endif // (BLE_APP_PRESENT) // removed for rom 20200226
...
//#if (AHI_TL_SUPPORT)    // removed by asr for rom 20200227
    TASK_AHI,
//#endif // (AHI_TL_SUPPORT)  // removed by asr for rom 20200227
...
#define RWIP_MINIMUM_SLEEP_TIME                (36) //(1) modified from 1 to 36-11.25 ms
