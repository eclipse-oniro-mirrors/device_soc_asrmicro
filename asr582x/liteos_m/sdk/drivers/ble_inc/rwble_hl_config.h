...
//#define BLE_NB_PROFILES   (CFG_NB_PRF)            // removed for rom 20200323
#include "rwprf_config.h"
#else
#define BLE_PROFILES      (0)
//#define BLE_NB_PROFILES   (0)                     // removed for rom 20200323
#endif // CFG_PRF
#define BLE_NB_PROFILES   (CFG_NB_PRF)            // added  for rom 20200323
