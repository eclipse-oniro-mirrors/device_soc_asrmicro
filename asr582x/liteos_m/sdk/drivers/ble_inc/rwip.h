...
extern struct rwip_prio rwip_priority[RWIP_PRIO_IDX_MAX];    // modified for rom 20200315
#if (RW_WLAN_COEX || RW_MWS_COEX)
/// API for COEX configuration
//extern const uint8_t rwip_coex_cfg[RWIP_COEX_CFG_MAX];
extern uint8_t rwip_coex_cfg[RWIP_COEX_CFG_MAX];    // modified for rom 20200315
