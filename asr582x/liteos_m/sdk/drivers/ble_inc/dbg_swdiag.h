...
#define DBG_SWDIAG(bank , field , value)                                              \
    if(p_sw_to_hw)                                                                    \
    {                                                                                 \
        if(p_sw_to_hw[DBG_SWDIAG_##bank] != DBG_SWDIAG_UNDEFINED)                     \
        {                                                                             \
            SW_DIAG_SET( ((SW_DIAG_GET()) & (~(DBG_SWDIAG_##bank##_##field##_MASK << (8 * p_sw_to_hw[DBG_SWDIAG_##bank])))) | ((((value << DBG_SWDIAG_##bank##_##field##_OFFSET) & DBG_SWDIAG_##bank##_##field##_MASK) << (8*p_sw_to_hw[DBG_SWDIAG_##bank])))  );      \
        }                                                                             \
    }
//modified for rom code 20200224
