...
{
    ASSERT_ERR(416, (((uint32_t)txtsize << 8) & ~((uint32_t)0x0000FF00)) == 0);
    ASSERT_ERR(417, (((uint32_t)params << 2) & ~((uint32_t)0x00000004)) == 0);
    ASSERT_ERR(418, (((uint32_t)warn << 1) & ~((uint32_t)0x00000002)) == 0);
    ASSERT_ERR(419, (((uint32_t)trigg << 0) & ~((uint32_t)0x00000001)) == 0);
...
{
    ASSERT_ERR(420, (((uint32_t)txtsize << 8) & ~((uint32_t)0x0000FF00)) == 0);
...
{
    ASSERT_ERR(421, (((uint32_t)params << 2) & ~((uint32_t)0x00000004)) == 0);
...
{
    ASSERT_ERR(422, (((uint32_t)warn << 1) & ~((uint32_t)0x00000002)) == 0);
...
{
    ASSERT_ERR(423, (((uint32_t)trigg << 0) & ~((uint32_t)0x00000001)) == 0);
...
{
    ASSERT_ERR(424, (((uint32_t)param2 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    ASSERT_ERR(425, (((uint32_t)param1 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
{
    ASSERT_ERR(426, (((uint32_t)param2 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
...
{
    ASSERT_ERR(427, (((uint32_t)param1 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__INLINE uint32_t asrt_line_getf(void)
{
    ...
    ASSERT_ERR(428, (localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

__INLINE void asrt_line_setf(uint32_t line)
{
    ASSERT_ERR(429, (((uint32_t)line << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
...
__INLINE uint32_t asrt_addr_getf(void)
{
    ...
    ASSERT_ERR(430, (localVal & ~((uint32_t)0xFFFFFFFF)) == 0);
    return (localVal >> 0);
}

__INLINE void asrt_addr_setf(uint32_t addr)
{
    ASSERT_ERR(431, (((uint32_t)addr << 0) & ~((uint32_t)0xFFFFFFFF)) == 0);
