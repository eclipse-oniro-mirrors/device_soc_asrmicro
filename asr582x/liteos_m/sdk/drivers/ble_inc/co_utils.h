...
extern struct bd_addr co_default_bdaddr; // modified by asr 20200417
/// NULL Key
...
#define SETF(__r, __f, __v)                                                      \
    do {                                                                         \
        ASSERT_INFO(3605,  ( ( ( (__v) << (__f##_LSB) ) & ( ~(__f##_MASK) ) ) ) == 0 ,(__f##_MASK), (__v)); \
...
#define SETB(__r, __b, __v)                                                      \
    do {                                                                         \
        ASSERT_ERR(3115,  ( ( ( (__v ? 1 : 0) << (__b##_POS) ) & ( ~(__b##_BIT) ) ) ) == 0 ); \
