...
#define BLE_NORMAL_WIN_SIZE              20 // 14->20 modified for sonata
...
#if (BLE_OBSERVER)
#define BLE_DUPLICATE_FILTER_MAX    (100) // (10)->(100) modified for sonata dip_adv_p2p_tc_107
#endif //(BLE_OBSERVER)
...
#define BLE_MAX_SW_PAT_LEN     0x4B // 12 -> 0x4B modified for sonata according to spec core 5.1
